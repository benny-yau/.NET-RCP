...
namespace MacroManager
{
	public class PluginMain : IPlugin
	{
        ...
        private String pluginDesc = "Adds simple macro capabilities";
        ...
        private void CreateMainMenuItems()
        {
            ...
            this.editMenuItem = new ToolStripMenuItem(TextHelper.GetString("Label.EditMacros"), PluginBase.MainForm.FindImage("314"), this.EditMenuItemClick, Keys.Control | Keys.F10);
