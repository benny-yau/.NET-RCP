...
namespace SamplePlugin
{
	public class PluginMain : IPlugin
	{
        ...
        private String pluginDesc = "Sample plugin";
		...
		public void HandleEvent(Object sender, NotifyEvent e, HandlingPriority priority)
		{
            switch (e.Type)
            {
                case EventType.UIRefresh:
                    pluginUI.Output.Text += "UI Refresh. \r\n";
                    break;

                case EventType.Command:
                    string cmd = (e as DataEvent).Action;
                    if (cmd == "FileExplorer.PromptHere")
                        pluginUI.Output.Text += "Command prompt.\r\n";
                    break;
            }
		}
        ...
        public void AddEventHandlers()
        {
            ...
            EventManager.AddEventHandler(this, EventType.Command | EventType.UIRefresh); 
        }
